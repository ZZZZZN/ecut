      		...
      		<form action="#" id="krtForm" class="form-horizontal">
				<table class="table table-bordered table-krt">
					<tr>
      					...
      					<td class="width-35"><input type="text" name="major_name" id="major_name" class="form-control"></td>
					 	 <td class="active width-15">
      						<label class="pull-right">
      							专业代码
      						</label>
      					</td>
      					<td class="width-35"><input type="text" name="major_code" id="major_code" class="form-control"></td>
  					</tr>
					<tr>
						<td class="active width-15">
							<label class="pull-right">
