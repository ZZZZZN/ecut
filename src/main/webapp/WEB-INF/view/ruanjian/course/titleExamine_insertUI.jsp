  ...
  <body class="hold-transition skin-blue sidebar-mini">
      	...
      	<div class="form-box">
      		<form action="#" id="krtForm" class="form-horizontal">
				<table class="table table-bordered table-krt">
      					...
      					<td class="width-35"><input type="text" name="title_examine_id" id="title_examine_id" class="form-control"></td>
					 	 <td class="active width-15">
      						<label class="pull-right">
      							题目id
      						</label>
      					</td>
      					<td class="width-35"><input type="text" name="title_id" id="title_id" class="form-control"></td>
  					</tr>
					<tr>
					 	 <td class="active width-15">
      						<label class="pull-right">
      					...
      					<td class="width-35"><input type="text" name="applicant" id="applicant" class="form-control"></td>
					 	 <td class="active width-15">
      						<label class="pull-right">
      							审核人
      						</label>
      					</td>
      					<td class="width-35"><input type="text" name="auditor" id="auditor" class="form-control"></td>
  					</tr>
					<tr>
					 	 <td class="active width-15">
      						<label class="pull-right">
      					...
      					<td class="width-35"><input type="text" name="status" id="status" class="form-control"></td>
					 	 <td class="active width-15">
      						<label class="pull-right">
    ...
    <script type="text/javascript">
		...
		function doSubmit(){//回调函数，在编辑和保存动作时，供openDialog调用提交表单。
			  $.ajax({   
			         type: "POST",
			         url:"<%=basePath%>ruanjian/course/titleExamine_insert",
