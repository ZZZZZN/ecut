					...
					<div class="col-xs-12">
						<div class="box">
							...
							<div class="box-body">
								<div class="row">
									<div class="col-sm-12">
										<shiro:hasPermission name="major:insert">
	...
	<script type="text/javascript">
   	    ...
   	    function initDatatable() {
   	        datatable = $('#datatable').DataTable({
	            ...
	            "ajax": {
	                "url": "<%=basePath%>ruanjian/course/major_list",
	                "type": "post",
	                "data": function (d) {
	            ...
	            "columnDefs": [
	                {
	                    ...
	                    "render": function(data, type, row) {
	                        return  ' <shiro:hasPermission name="major:see">'
   	    ...
   	    $(function(){
	        ...
	        //新增
	   	    $("#insertBtn").click(function(){
	   			openDialog("新增专业信息","<%=basePath%>ruanjian/course/major_insertUI","800px", "380px","");
	   	    });
	   	    
	   	    //查看
	   	    $(document).on("click",".seeBtn",function(){
	   			var id = $(this).attr("rid");
	   			openDialogView("查看表单","<%=basePath%>ruanjian/course/major_seeUI?id="+id,"800px", "380px","");
	   	    });
	   	   
	   	    //修改
	   	    $(document).on("click",".updateBtn",function(){
	   		    var id = $(this).attr("rid");
	   			openDialog("修改专业信息","<%=basePath%>ruanjian/course/major_updateUI?id="+id,"800px", "380px","");
	   	    });
	   	    ...
	   	    $(document).on("click",".deleteBtn",function(){
	   	    	...
	   	    	var fun = function(){
	   	    	 $.ajax({   
			         type: "POST",
			         url:"<%=basePath%>ruanjian/course/major_delete?id="+id,
			         beforeSend:function(){
			         	return loading();
			         },
