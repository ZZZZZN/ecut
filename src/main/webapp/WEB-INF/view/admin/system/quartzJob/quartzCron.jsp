...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		<!-- Main content -->
		<section style="padding: 0 15px 0 15px">
			<div class="row">
				<div class="col-xs-12">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="second">
								...
								<div class="imp secondList">
									<input type="checkbox" value="1">01 <input
										type="checkbox" value="2">02 <input
										type="checkbox" value="3">03 <input
										type="checkbox" value="4">04 <input
										type="checkbox" value="5">05 <input
										type="checkbox" value="6">06 <input
										type="checkbox" value="7">07 <input
										type="checkbox" value="8">08 <input
										type="checkbox" value="9">09 <input
										type="checkbox" value="10">10
								</div>
								<div class="imp secondList">
									<input type="checkbox" value="11">11 <input
										type="checkbox" value="12">12 <input
										type="checkbox" value="13">13 <input
										type="checkbox" value="14">14 <input
										type="checkbox" value="15">15 <input
										type="checkbox" value="16">16 <input
										type="checkbox" value="17">17 <input
										type="checkbox" value="18">18 <input
										type="checkbox" value="19">19 <input
										type="checkbox" value="20">20
								</div>
								<div class="imp secondList">
									<input type="checkbox" value="21">21 <input
										type="checkbox" value="22">22 <input
										type="checkbox" value="23">23 <input
										type="checkbox" value="24">24 <input
										type="checkbox" value="25">25 <input
										type="checkbox" value="26">26 <input
										type="checkbox" value="27">27 <input
										type="checkbox" value="28">28 <input
										type="checkbox" value="29">29 <input
										type="checkbox" value="30">30
								</div>
								<div class="imp secondList">
									<input type="checkbox" value="31">31 <input
										type="checkbox" value="32">32 <input
										type="checkbox" value="33">33 <input
										type="checkbox" value="34">34 <input
										type="checkbox" value="35">35 <input
										type="checkbox" value="36">36 <input
										type="checkbox" value="37">37 <input
										type="checkbox" value="38">38 <input
										type="checkbox" value="39">39 <input
										type="checkbox" value="40">40
								</div>
								<div class="imp secondList">
									<input type="checkbox" value="41">41 <input
										type="checkbox" value="42">42 <input
										type="checkbox" value="43">43 <input
										type="checkbox" value="44">44 <input
										type="checkbox" value="45">45 <input
										type="checkbox" value="46">46 <input
										type="checkbox" value="47">47 <input
										type="checkbox" value="48">48 <input
										type="checkbox" value="49">49 <input
										type="checkbox" value="50">50
								</div>
								<div class="imp secondList">
									<input type="checkbox" value="51">51 <input
										type="checkbox" value="52">52 <input
										type="checkbox" value="53">53 <input
										type="checkbox" value="54">54 <input
										type="checkbox" value="55">55 <input
										type="checkbox" value="56">56 <input
										type="checkbox" value="57">57 <input
										type="checkbox" value="58">58
								</div>
							</div>
							<div class="tab-pane" id="minute">
								...
								<div class="imp minList">
									<input type="checkbox" value="51">51 <input
										...
										type="checkbox" value="56">56 <input
										type="checkbox" value="57">57 <input
										type="checkbox" value="58">58 <input
							...
							<div class="tab-pane" id="hour">
								...
								<div class="imp hourList">
									AM: <input type="checkbox" value="0">00
									<input type="checkbox" value="1">01 <input
										type="checkbox" value="2">02 <input
										type="checkbox" value="3">03 <input
										type="checkbox" value="4">04 <input
										...
										type="checkbox" value="8">08 <input
										type="checkbox" value="9">09 <input
										type="checkbox" value="10">10 <input
										type="checkbox" value="11">11
								</div>
								<div class="imp hourList">
									PM: <input type="checkbox" value="12">12
									<input type="checkbox" value="13">13 <input
										...
										type="checkbox" value="18">18 <input
										type="checkbox" value="19">19 <input
										type="checkbox" value="20">20 <input
										type="checkbox" value="21">21 <input
										type="checkbox" value="22">22 <input
										type="checkbox" value="23">23
								</div>
							</div>
							<div class="tab-pane" id="day">
								...
								<div class="line">
									...
									周期从 <input class="numberspinner form-control"
										style="width:60px;" data-options="min:1,max:31" value="1">
									- <input class="numberspinner form-control" style="width:60px;"
								...
								<div class="line">
									...
									每月 <input class="numberspinner form-control"
										style="width:60px;" data-options="min:1,max:31" value="1">
									号最近的那个工作日
								</div>
								<div class="line">
								...
								<div class="imp dayList">
									<input type="checkbox" value="1">1 <input
										type="checkbox" value="2">2 <input
										type="checkbox" value="3">3 <input
										type="checkbox" value="4">4 <input
										type="checkbox" value="5">5 <input
										type="checkbox" value="6">6 <input
										type="checkbox" value="7">7 <input
										type="checkbox" value="8">8 <input
										type="checkbox" value="9">9 <input
										type="checkbox" value="10">10 <input
										type="checkbox" value="11">11 <input
										type="checkbox" value="12">12 <input
										type="checkbox" value="13">13 <input
										type="checkbox" value="14">14 <input
										type="checkbox" value="15">15 <input
								...
								<div class="imp dayList">
									<input type="checkbox" value="17">17 <input
										...
										type="checkbox" value="28">28 <input
										type="checkbox" value="29">29 <input
										type="checkbox" value="30">30 <input
							...
							<div class="tab-pane" id="month">
								...
								<div class="line">
									...
									周期从 <input class="numberspinner form-control"
										style="width:60px;" data-options="min:1,max:12" value="1">
									- <input class="numberspinner form-control" style="width:60px;"
							...
							<div class="tab-pane" id="week">
								...
								<div class="line">
									...
									周期 从星期<input class="numberspinner form-control"
										style="width:60px;" data-options="min:1,max:7" value="1">
									- <input class="numberspinner form-control" style="width:60px;"
										data-options="min:2,max:7" value="2">
								</div>
								<div class="line">
									<input type="radio" name="week" onclick="weekOfDay(this)">
									第<input class="numberspinner form-control" style="width:60px;"
								...
								<div class="line">
									...
									本月最后一个星期<input class="numberspinner form-control"
										style="width:60px;" data-options="min:1,max:7" value="1">
								</div>
								<div class="line">
							...
							<div class="tab-pane" id="year">
								...
								<div class="line">
									...
									从 <input class="numberspinner form-control" style="width:90px;"
										data-options="min:2016,max:3000" value="2016"> - <input
										class="numberspinner form-control" style="width:90px;"
		...
		<div style="height:100px;padding: 0 15px 0 15px"> 
				<table style="height: 100px;;width: 100%">
					<tbody>
						...
						<tr>
							<td>表达式字段:</td>
							<td><input type="text" name="v_second"
								class="col form-control" style="width:50px;background-color:#fff"
								value="*" readonly="readonly" /></td>
							<td><input type="text" name="v_min"
								class="col form-control" style="width:50px;background-color:#fff"
								value="*" readonly="readonly" /></td>
							<td><input type="text" name="v_hour"
								class="col form-control" style="width:50px;background-color:#fff"
								value="*" readonly="readonly" /></td>
							<td><input type="text" name="v_day"
								class="col form-control" style="width:50px;background-color:#fff"
								value="*" readonly="readonly" /></td>
							<td><input type="text" name="v_mouth"
								class="col form-control" style="width:50px;background-color:#fff"
								value="*" readonly="readonly" /></td>
							<td><input type="text" name="v_week"
								class="col form-control" style="width:50px;background-color:#fff"
								value="?" readonly="readonly" /></td>
							<td><input type="text" name="v_year"
								class="col form-control" style="width:50px;background-color:#fff"
						...
						<tr>
							...
							<td colspan="7"><input type="text" name="cron"
								class="form-control" style="width:200px;background-color:#fff"
								value="* * * * * ? " id="cron" readonly="readonly" /></td>
						</tr>
					</tbody>
				</table>
		</div>
	...
	<script src="<%=basePath%>static/plugins/quartzCron/cron.js"></script>
