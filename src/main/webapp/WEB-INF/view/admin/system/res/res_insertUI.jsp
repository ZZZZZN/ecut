  ...
  <body class="hold-transition skin-blue sidebar-mini">
      			...
      			<table class="table table-bordered table-krt">
      				<tr>
      					...
      					<td class="width-35">
      						<div class="input-group">
								<input type="text" name="pname" value="${res.name}" id="pname" class="form-control" readonly="readonly">
								<span class="input-group-btn">
									<button class="btn btn-primary btn-flat" id="resTreeBtn" type="button"><i class="fa fa-search"></i></button>
								</span>
								<!-- 参数 -->
								<input type="hidden" name="pid" id="pid" value="${res.id}" class="form-control">
							</div>
      					</td>
      					<td class="active width-15">
      						<label class="pull-right">
      					...
      					<td class="width-35">
      						<input type="text" name="name" id="name" class="form-control" rangelength="1,50" required>
      					</td>
      				</tr>
      				<tr>
      					<td class="active width-15">
      				...
      				<tr>
      					...
      					<td class="width-35">
							...
							<input id="icon" type="hidden" value="" name="icon">
      					...
      					<td class="width-35">
      						<input type="radio" name="type" value="url" class="minimal" checked="checked"> 菜单
      						<input type="radio" name="type" value="button" class="minimal"> 按钮 
      					</td>
      				</tr>
      				<tr>
      					<td class="active width-15">
    ...
    <script type="text/javascript">
		...
		function doSubmit(){//回调函数，在编辑和保存动作时，供openDialog调用提交表单。
			  $.ajax({   
			         type: "POST",
			         url:"<%=basePath%>admin/system/res/res_insert",
